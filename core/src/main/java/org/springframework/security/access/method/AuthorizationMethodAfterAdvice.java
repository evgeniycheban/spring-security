...
/**
 * An Authorization manager advice that can determine if an {@link Authentication} has
 * access to the returned object from the {@link MethodInvocation}. The
 * {@link #getMethodMatcher()} describes when the advice applies for the method.
 *
